...
import {
  createEnterpriseDTOS,
  companyAddress,
} from "@app/models/Enterprise_models";

const prisma = new PrismaClient();

export class EnterpriseRepository {
  async createEnterprise(
    enterpriseData: createEnterpriseDTOS,
  ...
  async findEnterpriseByCnpjAnbPopularName(cnpj: string, popularName: string) {
